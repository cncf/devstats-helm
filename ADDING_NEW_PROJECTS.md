...
- `git pull`.
- Make sure you use test images, not test, add `affiliationsImage='lukaszgryglicki/devstats-test',provisionImage='lukaszgryglicki/devstats-test',syncImage='lukaszgryglicki/devstats-minimal-test'`.
...
- Add each, update cronjobs, static & ingress, vars, merge each, update grafanas dashboards, fetch them, update shared grafana data, generate affiliations task, reinit all CNCF, projects health(s) reports.
