...
helm install devstats-prod-backups ./devstats-helm --set skipSecrets=1,skipPVs=1,skipBootstrap=1,skipProvisions=1,skipCrons=1,skipGrafanas=1,skipServices=1,skipPostgres=1,skipIngress=1,skipStatic=1,backupsCron='0 3 * * *' || exit 1
helm list || exit 1
